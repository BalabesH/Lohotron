...
namespace Lohotron
{
    public partial class Form1 : Form
    {
        ...
        private void StartButton_Click(object sender, EventArgs e)
        {
            ...
            {
                case 1:
                    ResultLabel.Text = $"Совпал один номер: {Play.Result}! \nВаш выигрыш составил 5 вымышленных рублей!";
                    break;
                case 2:
                    ResultLabel.Text = $"Совпало два номера: {Play.Result}! \nВаш выигрыш составил 25 вымышленных рублей!";
                    break;
                case 3:
                    ResultLabel.Text = $"Совпало три номера: {Play.Result}! \nВаш выигрыш составил 125 вымышленных рублей!";
                    break;
                case 4:
                    ResultLabel.Text = $"Совпало четыре номера: {Play.Result}! \nВаш выигрыш составил 625 вымышленных рублей!";
                    break;
                case 5:
